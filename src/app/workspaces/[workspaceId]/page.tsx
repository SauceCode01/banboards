...
const WorkspacePage = () => { 
  ...
  const actions = [
    {
      name: "Boards",
      href: `/workspaces/${activeWorkspaceId}/boards`,
      description: "View and manage your boards",
    },
    {
      name: "Collaborators",
      href: `/workspaces/${activeWorkspaceId}/collaborators`,
      description: "Manage who has access to this workspace",
    },
    {
      name: "Edit Workspace",
      href: `/workspaces/${activeWorkspaceId}/edit`,
      description: "Change the name of your workspace",
    },
    {
      name: "Delete Workspace",
      href: `/workspaces/${activeWorkspaceId}/delete`,
