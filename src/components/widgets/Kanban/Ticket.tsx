...
export const TicketCard: React.FC<TicketCardProps> = ({ ticket, onDelete }) => {
  ...
  return (
    <div ref={setNodeRef} style={style} className="bg-slate-800 rounded-md p-3 shadow-sm border border-slate-700 hover:border-slate-500 select-none">
