...
export function MultipleContainers({
  ...
  const [items, setItems] = useState<Items>(
    () =>
      initialItems ?? {
        A: createRange(itemCount, (index) => `A${index + 1} This is description of my task gnkewnlkgwlkgweklewjklewjlkewjkl`),
        B: createRange(itemCount, (index) => `B${index + 1} This is my hobby`),
        C: createRange(itemCount, (index) => `C${index + 1} I'm a fan of messi`),
